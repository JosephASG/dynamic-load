...
exports.updateCityId = exports.getTotalCities = exports.getSite = exports.getCityId = exports.deleteCityId = exports.createTurismSite = void 0;
var _regenerator = _interopRequireDefault(require("@babel/runtime/regenerator"));
var _asyncToGenerator2 = _interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator"));
var _database = require("../database");
var getSite = /*#__PURE__*/function () {
  ...
  return function getSite(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getSite = getSite;
var createTurismSite = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var _req$body, nameSite, locationSite, telSite, codCiud, boolSite, pool, existingSite, lastSite, nextId, lastId, numericPart, result;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body = req.body, nameSite = _req$body.nameSite, locationSite = _req$body.locationSite, telSite = _req$body.telSite, codCiud = _req$body.codCiud;
          boolSite = req.body.boolSite;
        ...
        case 9:
          pool = _context2.sent;
          _context2.next = 12;
          return pool.request().input("nameSite", _database.sql.Char(50), nameSite).query(_database.querys.getTurisSiteName);
        case 12:
          existingSite = _context2.sent;
        ...
        case 16:
          _context2.next = 18;
          return pool.request().query(_database.querys.lastCodeSiteRegister);
        case 18:
          lastSite = _context2.sent;
          nextId = "ST0001"; // Valor predeterminado si no hay registros
          if (lastSite.recordset.length > 0) {
            lastId = lastSite.recordset[0].cod_turis;
            numericPart = parseInt(lastId.substring(2)) + 1;
            nextId = "ST" + numericPart.toString().padStart(4, '0');
          }
          _context2.next = 23;
          return pool.request().input("idSite", _database.sql.Char(15), nextId).input("nameSite", _database.sql.Char(50), nameSite).input("locationSite", _database.sql.Char(50), locationSite).input("telSite", _database.sql.Char(50), telSite).input("boolSite", _database.sql.Bit, boolSite).input("codCiud", _database.sql.Char(50), codCiud).query(_database.querys.addNewTurisSite);
        case 23:
        ...
        case 28:
          ...
          req.flash('message', 'Error al crear sitio turístico:', _context2.t0.message);
          return _context2.abrupt("return", res.redirect('/'));
        case 32:
        case "end":
  ...
  return function createTurismSite(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.createTurismSite = createTurismSite;
...
var updateCityId = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res) {
    var _req$body2, idCiudad, nombreCiudad, estadoCiudad, pool, result;
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _req$body2 = req.body, idCiudad = _req$body2.idCiudad, nombreCiudad = _req$body2.nombreCiudad, estadoCiudad = _req$body2.estadoCiudad;
